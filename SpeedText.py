...
class Game:
    def __init__(self):
        ...
        self.wpm = 0
        self.end = False
        self.HEAD_C = (15, 217, 72)
        self.TEXT_C = (240, 240, 240)
        self.RESULT_C = (255, 70, 70)

        pygame.init()
        self.open_img = pygame.image.load('data/fon.jpg')
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load('data/fon.jpg')


        self.screen = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption('Скорость набора текста')
    ...
    def show_results(self, screen):
        if (not self.end):
            ...
            # Загрузка иконки
            self.time_img = pygame.image.load('data/fon.jpg')
